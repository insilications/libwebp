...
Version  : 1.2.0
Release  : 32
URL      : https://github.com/webmproject/libwebp/archive/v1.2.0/libwebp-1.2.0.tar.gz
Source0  : https://github.com/webmproject/libwebp/archive/v1.2.0/libwebp-1.2.0.tar.gz
...
%prep
%setup -q -n libwebp-1.2.0
cd %{_builddir}/libwebp-1.2.0
pushd ..
cp -a libwebp-1.2.0 build32
popd
pushd ..
cp -a libwebp-1.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612036604
...
cp %{_builddir}/libwebp-1.2.0/COPYING %{buildroot}/usr/share/package-licenses/libwebp/59cd938fcbd6735b1ef91781280d6eb6c4b7c5d9
pushd ../build32/
%make_install32
