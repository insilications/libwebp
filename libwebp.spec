...
Version  : 1.0.1
Release  : 24
URL      : https://github.com/webmproject/libwebp/archive/v1.0.1.tar.gz
Source0  : https://github.com/webmproject/libwebp/archive/v1.0.1.tar.gz
...
%prep
%setup -q -n libwebp-1.0.1
pushd ..
cp -a libwebp-1.0.1 build32
popd
pushd ..
cp -a libwebp-1.0.1 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1542923250
...
/usr/lib64/haswell/libwebp.so.7.0.3
/usr/lib64/haswell/libwebpdemux.so.2
/usr/lib64/haswell/libwebpdemux.so.2.0.5
/usr/lib64/haswell/libwebpmux.so.3
/usr/lib64/haswell/libwebpmux.so.3.0.3
/usr/lib64/libwebp.so.7
/usr/lib64/libwebp.so.7.0.3
/usr/lib64/libwebpdemux.so.2
/usr/lib64/libwebpdemux.so.2.0.5
/usr/lib64/libwebpmux.so.3
/usr/lib64/libwebpmux.so.3.0.3

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libwebp.so.7
/usr/lib32/libwebp.so.7.0.3
/usr/lib32/libwebpdemux.so.2
/usr/lib32/libwebpdemux.so.2.0.5
/usr/lib32/libwebpmux.so.3
/usr/lib32/libwebpmux.so.3.0.3
